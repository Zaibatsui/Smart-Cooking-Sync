...
const CookingSync = () => {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-slate-900' : 'bg-gradient-to-br from-emerald-50 via-white to-teal-50'}`}>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          {/* Settings Panel */}
          {showSettings && (
            <Card className="mb-4 border-emerald-200 dark:border-slate-700">
        ...
        <Tabs defaultValue="add" className="space-y-6">
          ...
          <TabsContent value="add">
            ...
            {/* Current Dishes List */}
            {dishes.length > 0 && (
              <Card className="mt-6 border-emerald-200 dark:border-slate-700">
                <CardHeader>
