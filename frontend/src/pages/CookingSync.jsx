...
const CookingSync = () => {
  ...
  const [notificationsEnabled, setNotificationsEnabled] = useState(savedSettings?.notificationsEnabled !== undefined ? savedSettings.notificationsEnabled : true);
                          ...
                          {favoriteDishes.map(dish => (
                            ...
                            >
                              ...
                              <Button
                                ...
                                className="h-6 w-6 p-0 text-slate-400 hover:text-red-500 dark:text-gray-500 dark:hover:text-red-400"
                        ...
                        <div className="flex flex-wrap gap-2">
                          {recentDishes.map(dish => (
                            ...
                            >
                              ...
                              >
                                <Star className="w-4 h-4 text-slate-400 dark:text-gray-500 hover:text-amber-500" />
                              </Button>
                              <Button
                                variant="ghost"
                                size="sm"
